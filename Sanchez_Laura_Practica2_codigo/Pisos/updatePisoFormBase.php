...
<h3 class="text-center">Introduce el código del piso que quieres modificar:</h3>
        <div class="formularioBajaPiso m-auto border-border-black bg-white w-25 p-5">
      
            <form method="post" action="updatePisoForm.php">
                <div class="mb-3">
                    <label for="codigoPiso" class="form-label">Código:</label>
