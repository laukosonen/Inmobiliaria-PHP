...
<h3 class="text-center">Introduce el nombre del usuario que quieres buscar:</h3>
        <div class="formularioBuscarUsuario m-auto border-border-black bg-white w-25 p-5">
